...
public class DrawMenu implements Listener {
    ...
    public DrawMenu(String name, int size, OptionClickEventHandler handler, Plugin plugin) {
        this.name = name;
        this.size = size;
    ...
    public DrawMenu setOption(int position, ItemStack icon, String name, String... info) {
