...
public class MortalZombie extends EntityZombie
{
    ...
    public MortalZombie(World world)
    {
        ...
        try
        {
            ...
            this.getAttributeInstance(GenericAttributes.ATTACK_DAMAGE).setValue(160);
        } catch (Exception exc)
        {
            exc.printStackTrace();
        }
    ...
    /*
     * Removed because it is giving issues and appears to be unused? protected void aD() { super.ad(); this.getAttributeInstance(GenericAttributes.e).setValue(4.0D); // Original 3.0D }
     */
}