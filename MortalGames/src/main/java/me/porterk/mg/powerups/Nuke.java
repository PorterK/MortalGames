...
public class Nuke extends Powerup
{
    ...
    public void start(Player p)
    {
        ...
        api.broadcastMessage(ChatColor.GREEN + p.getDisplayName() + ChatColor.DARK_RED + " has used" + ChatColor.GREEN + " Nuke" + ChatColor.DARK_RED + "!");
        ...
        p.sendMessage(Main.tag + ChatColor.DARK_RED + "You killed " + ChatColor.GREEN + mobs + ChatColor.DARK_RED + " mobs!");
    }
}