...
public void initiate(Player p){
	...
	public void enabledMessage(Player p, String perk){
		...
		api.broadcastMessage(ChatColor.DARK_RED + "The " + ChatColor.GREEN + perk +
				ChatColor.DARK_RED + " perk has been enabled by " + ChatColor.GREEN + 
				p.getDisplayName() + ChatColor.DARK_RED + "!");
	...
	public void disabledMessage(String perk){
		...
		api.broadcastMessage(ChatColor.DARK_RED + "The " + ChatColor.GREEN + perk + 
				ChatColor.DARK_RED + " has been disabled!");
